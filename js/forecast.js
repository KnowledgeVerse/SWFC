...
function renderGrid() {
  ...
  legendHtml += `<div class="legend-section" style="padding:50px; display:flex; flex-direction:column; justify-content:center; flex-grow:1;"><strong style="font-size: 4em; margin-bottom: 50px; display:block; white-space:nowrap;">Distribution (वितरण)</strong><div style="display:flex; flex-direction:column; gap:50px;">`;
